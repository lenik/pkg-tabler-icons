...
.\build.ps1 -Name icons-tabler-icons -Version 1.2.3
```
...
```
<project>/.config/icons-tabler-icons/<packaging>.build-host
$HOME/.config/icons-tabler-icons/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-tabler-icons
```
